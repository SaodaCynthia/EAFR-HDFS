...
public static ArrayList<Long> sizes= new ArrayList<Long> ();
  ...
  public static ArrayList<Long> sizes(){
   ...
   public static ArrayList<Long> getFileSize() throws IOException {
 ...
 ArrayList <Long> randomFileSize= new ArrayList<Long> ();
	   Random randomizer= new Random();
	   
	   for (int i=0; i<totalFiles;i++) {
		   int num=randomizer.nextInt(fileSize.size());
		   randomFileSize.add(fileSize.get(num));
	   }
	...
	ArrayList<Long> randomFileSize=getFileSize();
	ArrayList<Long> sizes=sizes();
	randomFileSize.addAll(sizes);
	for (int i=0;i<randomFileSize.size();i++){
		
		writeFile(randomFileSize.get(i),i);
	}
}
